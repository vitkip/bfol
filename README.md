...
|---|---|---|---|
| ເນື້ອຫາ | `news` | ✅ ພັດທະນາແລ້ວ | |
| ເນື້ອຫາ | `events` | ✅ ພັດທະນາແລ້ວ | |
| ເນື້ອຫາ | `pages` | ✅ ພັດທະນາແລ້ວ | |
| ເນື້ອຫາ | `media_items` | ✅ ພັດທະນາແລ້ວ | |
| ເນື້ອຫາ | `documents` | ✅ ພັດທະນາແລ້ວ | |
| ເນື້ອຫາ | `categories` | ✅ ພັດທະນາແລ້ວ | |
| ເນື້ອຫາ | `tags` | ✅ ພັດທະນາແລ້ວ | |
| ເນື້ອຫາ | `event_tags` | ✅ ພັດທະນາແລ້ວ | |
| ພາລະກິດ | `partner_organizations` | ✅ ພັດທະນາແລ້ວ | |
| ພາລະກິດ | `mou_agreements` | ✅ ພັດທະນາແລ້ວ | |
| ພາລະກິດ | `monk_exchange_programs` | ✅ ພັດທະນາແລ້ວ | |
| ພາລະກິດ | `aid_projects` | ✅ ພັດທະນາແລ້ວ | |
| ໜ້າຫຼັກ | `hero_slides` | ✅ ພັດທະນາແລ້ວ | |
| ໜ້າຫຼັກ | `banners` | ✅ ພັດທະນາແລ້ວ | |
| ໜ້າຫຼັກ | `committee_members` | ✅ ພັດທະນາແລ້ວ | |
| ລະບົບ | `users` | ✅ ພັດທະນາແລ້ວ | |
| ລະບົບ | `site_settings` | ✅ ພັດທະນາແລ້ວ | |
