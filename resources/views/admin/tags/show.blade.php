...
<div class="max-w-xl mx-auto">
    <div class="bg-surface-container-lowest rounded-xl shadow p-6 mb-6">
        <h2 class="text-lg font-bold mb-4">Tag Details</h2>
        <div class="mb-4">
        ...
        <div class="flex gap-2 mt-4">
            <a href="{{ route('admin.tags.edit', $tag) }}" class="primary-gradient text-white font-semibold px-5 py-2 rounded-lg hover:opacity-90 transition">Edit</a>
